...
const VoiceCloner = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white p-4 sm:p-8">
      <ResizablePanel className="w-full max-w-6xl mx-auto bg-gray-900 rounded-xl shadow-2xl overflow-hidden">
        <div className="flex flex-col h-full">
          ...
          <div className="flex-grow p-4 sm:p-8 bg-gray-900">

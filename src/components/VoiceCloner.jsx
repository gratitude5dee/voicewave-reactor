      ...
      <div className="w-full max-w-6xl mx-auto bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
        <div className="h-96 bg-black rounded-t-xl overflow-hidden relative">
          ...
          <Button
            ...
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white text-purple-900 hover:bg-purple-100 transition-all duration-300 font-bold py-3 px-6 rounded-full shadow-lg"
          >
        ...
        <div className="p-8 bg-gray-900">
          ...
          <div className="flex space-x-4 mb-6">
            <Input
              ...
              className="flex-grow text-lg p-4 bg-gray-800 border-gray-700 text-white placeholder-gray-400"
            />
            <Button onClick={handleSpeak} className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 rounded-lg transition-all duration-300">
              <Mic className="mr-2 h-5 w-5" /> Speak
            </Button>
          </div>
          <div className="flex space-x-4 mb-6">
            <Button variant="outline" className="flex-grow bg-gray-800 text-white border-gray-700 hover:bg-gray-700 transition-all duration-300" onClick={() => setIsMixVoicesOpen(true)}>
              Mix Voices
            </Button>
            <Button variant="outline" className="flex-grow bg-gray-800 text-white border-gray-700 hover:bg-gray-700 transition-all duration-300" onClick={() => setIsSpeedEmotionOpen(true)}>
